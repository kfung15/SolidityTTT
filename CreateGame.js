...
function createNewGame() {
  ...
  account = '0x694983d2C3f5751D318Fd20e489741a727B408d1'
  ...
  TTTContract.deploy({data:bytecode}).send({from:'0x694983d2C3f5751D318Fd20e489741a727B408d1',gas:1000000,gasPrice:web3.utils.toWei("0.0000000025","ether")}).then((newContractInstance) =>{TTTContract.options.address=newContractInstance.options.address});
